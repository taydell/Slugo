    ...
    <nav id="navbarPOS" class="navbar navbarBackColor navbar-fixed-top">
        <div class="navbarReposition">
            ...
            <ul class="nav navbar-nav" id="links">
                ...
                <li><a href="../views/news.php" <?php if($pageTitle == 'News') echo 'id = "currentPage"'; ?> class="hvr-underline-reveal">NEWS <i class="ion-ios-paper"></i></a></li>
                <li><a href="../views/sponsors.php" <?php if($pageTitle == 'Sponsors') echo 'id = "currentPage"'; ?> class="hvr-underline-reveal">SPONSORS <i class="ion-cash"></i></a></li>
                        ...
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <?php if($user->hasPermission('admin')) { ?>
                                    <li><a class="userBarMenuHover" href="../views/admin.php">Admin</a></li>
                                <?php } ?>
