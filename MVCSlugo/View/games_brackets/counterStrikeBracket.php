...
<div class="bracketContainer">
    <div id="banner" class="col-md-12">
        <img src="../content/images/counterStrike2.png" height="150px" width="150px">
        <img id="center" src="../content/images/Counter-Strike_Online_logo.png" height="100%" width="50%">
        <img src="../content/images/Counter-Strike-Source.png" height="150px" width="150px">
    </div>
    <?php if($user->isLoggedIn() && ($data->joinCounter == 0)) { ?>
    ...
    <?php } else if($user->isLoggedIn() && $data->joinCounter == 1) { ?>
        <div id="bracketButtons" class="col-md-12">
        ...
        <div class="md-content">
            ...
            <div class="popup">
                <form id="form">
                    ...
                    <input id="teamToDrop" type="hidden" name="tourney" value="joinCounter">
                    <input id="tourneyId" type="hidden" name="tourneyId" value="counterId">
                    <input id="tourneyTeam" type="hidden" name="tourneyTeam" value="counterTeam">
                    <br>
    ...
    <div id="bracketPageCounter" class="col-md-10">
            ...
            <div class="md-content">
                ...
                <div class="popup">
                    <form id="form">
                        ...
                        <input id="tourney" type="hidden" name="tourney" value="joinCounter">
                        <input id="tourneyId" type="hidden" name="tourneyId" value="counterId">
                        <input id="tourneyTeam" type="hidden" name="tourneyTeam" value="counterTeam">
                        <br>
                        <div class="btn-group-justified">
