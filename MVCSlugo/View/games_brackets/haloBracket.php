...
<div class="bracketContainer">
    <div id="banner" class="col-md-12">
        ...
        <img id="center" src="../content/images/haloBannerImage.png" height="100%" width="50%">
        <img src="../content/images/halo2.png" height="150px" width="150px">
    </div>
<?php if($user->isLoggedIn() && ($data->joinHalo == 0)) { ?>
...
<?php } else if($user->isLoggedIn() && $data->joinHalo == 1) { ?>
    <div id="bracketButtons" class="col-md-12">
...
<?php } ?>
        ...
        <div class="md-content">
            ...
            <div class="popup">
                <form id="form">
                    ...
                    <input id="teamToDrop" type="hidden" name="tourney" value="joinHalo">
                    <input id="tourneyId" type="hidden" name="tourneyId" value="haloId">
                    <input id="tourneyTeam" type="hidden" name="tourneyTeam" value="haloTeam">
                    <br>
    ...
    <div id="bracketPageHalo" class="col-md-10">
            ...
            <div class="md-content">
                ...
                <div class="popup">
                    <form id="form">
                        ...
                        <input id="tourney" type="hidden" name="tourney" value="joinHalo">
                        <input id="tourneyId" type="hidden" name="tourneyId" value="haloId">
                        <input id="tourneyTeam" type="hidden" name="tourneyTeam" value="haloTeam">
                        <br>
                        <div class="btn-group-justified">
