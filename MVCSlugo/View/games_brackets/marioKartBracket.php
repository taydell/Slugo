...
<div class="bracketContainer">
    <div id="banner" class="col-md-12">
        <img src="../content/images/marioOnKart.png" height="150px" width="150px">
        <img id="center" src="../content/images/marioKart.png" height="100%" width="50%">
        <img src="../content/images/MarioKartWiiLuigi.png" height="150px" width="150px">
    </div>
    <?php if($user->isLoggedIn() && ($data->joinMario == 0)) { ?>
    ...
    <?php } else if($user->isLoggedIn() && $data->joinMario == 1) { ?>
        <div id="bracketButtons" class="col-md-12">
        ...
        <div class="md-content">
            ...
            <div class="popup">
                <form id="form">
                    ...
                    <input id="teamToDrop" type="hidden" name="tourney" value="joinMario">
                    <input id="tourneyId" type="hidden" name="tourneyId" value="marioId">
                    <input id="tourneyTeam" type="hidden" name="tourneyTeam" value="marioTeam">
                    <br>
    ...
    <div id="bracketPageMario" class="col-md-10">
            ...
            <div class="md-content">
                ...
                <div class="popup">
                    <form id="form">
                        ...
                        <input id="tourney" type="hidden" name="tourney" value="joinMario">
                        <input id="tourneyId" type="hidden" name="tourneyId" value="marioId">
                        <input id="tourneyTeam" type="hidden" name="tourneyTeam" value="marioTeam">
                        <br>
                        <div class="btn-group-justified">
